...
public class TechFeedback extends javax.swing.JFrame {
    String table[][] = new String [100][];
    public TechFeedback()throws IOException {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TechFeedback.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new TechFeedback().setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(TechFeedback.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
